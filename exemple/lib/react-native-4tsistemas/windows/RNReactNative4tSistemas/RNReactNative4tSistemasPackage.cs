...
namespace React.Native.Calendar_4t.RNReactNativeCalendar_4t
{
    /// <summary>
    ...
    /// managers from).
    /// </summary>
    public class RNReactNativeCalendar_4tPackage : IReactPackage
    {
        /// <summary>
        ...
        public IReadOnlyList<INativeModule> CreateNativeModules(ReactContext reactContext)
        {
            ...
            {
                new RNReactNativeCalendar_4tModule(),
            };
        }
